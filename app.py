...
if module == "Módulo 1: Calculadora":
    ...
    st.sidebar.image("Logos/Escala_API.png", use_column_width=True)
    ...
    # Agregar imagen a la barra lateral
    st.sidebar.image("Logos/Módulo2.png", use_column_width=True)
...
# Agregar imagen a la barra lateral
    st.sidebar.image("Logos/Balancín.png", use_column_width=True)
